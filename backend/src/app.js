...
import periodAttendanceRoutes from "./routes/period-attendance.routes.js";
...
import portalStudentRoutes from "./routes/portal-student.routes.js";
...
app.use("/api/v1/period-attendance", authenticate, periodAttendanceRoutes);
...
app.use("/api/v1/portal/student", authenticatePortal, portalStudentRoutes);
