...
const getPageTitle = (pathname) => {
  ...
  if (pathname.endsWith("/edit")) return { title: "Edit Student", description: "Update an existing student record." };
  if (pathname.startsWith("/students/") && pathname !== "/students/new") return { title: "Student Details", description: "View student information and record history." };
