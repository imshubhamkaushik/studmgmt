...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/assignments", label: "Assignments", icon: ClipboardList, roles: ["admin", "staff", "teacher"] },
      { to: "/academic-setup", label: "Subjects & Terms", icon: BookOpen, roles: ["admin", "staff"] },
      { to: "/exams", label: "Exams", icon: FileSpreadsheet, roles: ["admin", "staff", "teacher"] },
      { to: "/mark-entry", label: "Mark Entry", icon: GraduationCap, roles: ["admin", "staff", "teacher"] },
      { to: "/report-cards", label: "Report Cards", icon: FileText, roles: ["admin", "staff", "teacher"] },
    ],
  },
  {
